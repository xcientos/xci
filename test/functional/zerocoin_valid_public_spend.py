...
from fake_stake.base_test import XCIENTOS_FakeStakeTest

class zXCIValidCoinSpendTest(XCIENTOS_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zXCIs..." % DENOM_TO_USE)
