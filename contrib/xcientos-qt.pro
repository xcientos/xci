...
RESOURCES += src/qt/xcientos.qrc src/qt/xcientos_locale.qrc

TRANSLATIONS += src/qt/locale/xcientos_bg.ts \
                src/qt/locale/xcientos_de.ts \
                src/qt/locale/xcientos_en.ts \
                src/qt/locale/xcientos_es.ts \
                src/qt/locale/xcientos_fi.ts \
                src/qt/locale/xcientos_fr.ts \
                src/qt/locale/xcientos_it.ts \
                src/qt/locale/xcientos_ja.ts \
                src/qt/locale/xcientos_pl.ts \
                src/qt/locale/xcientos_pt.ts \
                src/qt/locale/xcientos_ru.ts \
                src/qt/locale/xcientos_sk.ts \
                src/qt/locale/xcientos_sv.ts \
                src/qt/locale/xcientos_vi.ts \
                src/qt/locale/xcientos_zh_CN.ts \
                src/qt/locale/xcientos_zh_TW.ts
