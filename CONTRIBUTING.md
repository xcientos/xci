Contributing to XCIENTOS Core
============================

The XCIENTOS Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/xcientos-project/xcientos/blob/master/doc/translation_process.md)
...
The following applies to code changes to the XCIENTOS Core project, and is not to be
confused with overall XCIENTOS Network Protocol consensus changes.

Whether a pull request is merged into XCIENTOS Core rests with the project merge
...
Patches that change XCIENTOS consensus rules are considerably more involved than
...
Where a patchset proposes to change the XCIENTOS consensus, it must have been
...
The project leader is the release manager for each XCIENTOS Core release.
