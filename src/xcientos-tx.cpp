...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("XCIENTOS Core xcientos-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  xcientos-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xcientos transaction") + "\n" +
                               "  xcientos-tx [options] -create [commands]   " + _("Create hex-encoded xcientos transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded xcientos transaction
