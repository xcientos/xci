...
#ifndef XCIENTOS_ZXCIWALLET_H
#define XCIENTOS_ZXCIWALLET_H
...
public:
    CzXCIWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZXCI(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZXCI(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
