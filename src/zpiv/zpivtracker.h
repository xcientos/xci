...
#ifndef XCIENTOS_ZXCITRACKER_H
#define XCIENTOS_ZXCITRACKER_H
...
public:
    CzXCITracker(std::string strWalletFile);
    ~CzXCITracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzXCIWallet* zXCIWallet = NULL);
