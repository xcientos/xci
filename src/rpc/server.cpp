...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop XCIENTOS server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "XCIENTOS server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* XCIENTOS features */
        {"xcientos", "listmasternodes", &listmasternodes, true, true, false},
        {"xcientos", "getmasternodecount", &getmasternodecount, true, true, false},
        {"xcientos", "masternodeconnect", &masternodeconnect, true, true, false},
        {"xcientos", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"xcientos", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"xcientos", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"xcientos", "masternodecurrent", &masternodecurrent, true, true, false},
        {"xcientos", "masternodedebug", &masternodedebug, true, true, false},
        {"xcientos", "startmasternode", &startmasternode, true, true, false},
        {"xcientos", "createmasternodekey", &createmasternodekey, true, true, false},
        {"xcientos", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"xcientos", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"xcientos", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"xcientos", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"xcientos", "getmasternodescores", &getmasternodescores, true, true, false},
        {"xcientos", "preparebudget", &preparebudget, true, true, false},
        {"xcientos", "submitbudget", &submitbudget, true, true, false},
        {"xcientos", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"xcientos", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"xcientos", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"xcientos", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"xcientos", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"xcientos", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"xcientos", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xcientos", "checkbudgets", &checkbudgets, true, true, false},
        {"xcientos", "mnsync", &mnsync, true, true, false},
        {"xcientos", "spork", &spork, true, true, false},
        {"xcientos", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> xcientos-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:24424/\n";
}
