...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::XCI);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeXCIENTOSAmount"))
        SoftSetArg("-anonymizexcientosamount", settings.value("nAnonymizeXCIENTOSAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in xcientos.cpp during shotdown to also remove the window positions
