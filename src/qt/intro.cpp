...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("XCIENTOS Core"),
     ...
     * override -datadir in the xcientos.conf file in the default data directory
     * (to be consistent with xcientosd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
