...
/* XCIENTOS GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "XCIENTOS"
#define QAPP_ORG_DOMAIN "xcientos.org"
#define QAPP_APP_NAME_DEFAULT "XCIENTOS-Qt"
#define QAPP_APP_NAME_TESTNET "XCIENTOS-Qt-testnet"
