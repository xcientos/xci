...
/** Utility functions used by the XCIENTOS Qt UI.
 */
namespace GUIUtil
{
...
// Render XCIENTOS addresses in monospace font
...
// Parse "xcientos:" URI into recipient object, return true on successful parsing
